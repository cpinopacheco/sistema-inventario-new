...
const Navbar = ({ toggleSidebar, sidebarOpen }: NavbarProps) => {
  ...
  // Aseguramos que el ref no sea null cuando se pasa a useOnClickOutside
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              aria-haspopup="true"
            >
              <div className="w-10 h-10 rounded-full bg-primary-light bg-opacity-30 flex items-center justify-center">
