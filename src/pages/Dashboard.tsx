  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="bg-primary bg-opacity-10 px-6 py-4 border-b border-primary border-opacity-20 flex justify-between items-center">
        ...
        <motion.div
          ...
          className="bg-white rounded-lg shadow-md overflow-hidden"
        >
          <div className="bg-secondary bg-opacity-10 px-6 py-4 border-b border-secondary border-opacity-20 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-primary">
              Retiros Recientes
            </h2>
            <Link
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full flex items-center ${
                          product.stock > product.minStock * 2
                            ? "bg-primary-light bg-opacity-30 text-primary"
